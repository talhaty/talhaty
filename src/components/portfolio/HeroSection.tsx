...
const HERO_TEXTS = [
  "Music lover, coding adventurer.",
  "Solving problems one algorithm at a time.",
  "Traveler exploring code and the world.",
  "Anime, comics, and video games fuel my creativity.",
] as const;
            ...
            <Reveal delay={0.15}>
              <div className="max-w-2xl mx-auto md:mx-0">
                <p className="text-lg leading-relaxed text-foreground/80">
                  I'm a Machine Learning Engineer and full-stack developer turning data into insights. I build AI-powered apps, solve complex problems, and blend tech with creativity. When I’m not coding, you’ll find me exploring new places, vibing to music, or diving into anime, comics, and video games.
                </p>
              </div>
            </Reveal>
